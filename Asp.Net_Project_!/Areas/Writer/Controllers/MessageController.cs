...
namespace Asp.Net_Project__.Areas.Writer.Controllers
{
    ...
    public class MessageController : Controller
    {
        ...
        public async Task<IActionResult> ReceiverMessage(string p)
        {
            ...
            p = values.Email;
            var messageList = writerMessageManager.GetListRecieversMessage(p);
        ...
        public async Task<IActionResult> SenderMessage(string p)
        {
            var values = await _userManager.FindByNameAsync(User.Identity.Name);
            p = values.Email;
            var messageList = writerMessageManager.GetListSendersMessage(p);
            return View(messageList);
        }
        ...
        public async Task<IActionResult> SendMessage(WriterMessage p)
        {
            ...
            string fullname = values.writerUserName + " " + values.writerUserSurname; 
